                ...
                <div class="col-2">
                    <div
                        ...
                        @if (is_array($roleName))
                                ...
                                <input type="checkbox"
                                    name="permission-{{$roleView}}-view"
                                    class="mt-2 mb-3 ml-5" id="" 
                ...
                <div class="col-2">
                    <div
                        ...
                        @if (is_array($roleName))
                                ...
                                <input type="checkbox"
                                    name="permission-{{$rolecreate}}-create"
                                    class="mt-2 mb-3 ml-5" id="" 
                        ...
                        @else
                        <input type="checkbox"
                            name="permission-{{$roleName}}-create"
                            class="mt-2 mb-3" id="" 
                ...
                <div class="col-2">
                    <div
                        ...
                        @if (is_array($roleName))
                                ...
                                <input type="checkbox"
                                    name="permission-{{$roledelete}}-delete"
                                    class="mt-2 mb-3 ml-5" id="" 
                        ...
                        @else
                        <input type="checkbox"
                            name="permission-{{$roleName}}-delete"
                            class="mt-2 mb-3" id="" 
