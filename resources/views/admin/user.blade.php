                                ...
                                <tr>
                                    ...
                                    <td class="td-actions text-right">
                                        <a rel="tooltip" class="btn btn-danger btn-link" href="#" data-original-title=""
                                            data-toggle="tooltip" data-placement="bottom" title="Erase"
                                            id="delete-user">
                                            <i class="material-icons">delete</i>
                                            <div class="ripple-container"></div>
                                        </a>
                                        <a rel="tooltip" class="btn btn-success btn-link" href="#"
                                            data-original-title="" data-toggle="tooltip" data-placement="bottom"
                                            title="Edit" id="edit-user">
                    ...
                    <form class="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="bmd-form-group{{ $errors->has('role') ? ' has-danger' : '' }} mt-3">
                            {{-- <div class="input-group">
                                ...
                                <select class="form-control selectpicker" data-style="btn btn-link" id="role">
