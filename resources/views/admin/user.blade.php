                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="ml-2 badge badge-{{$user->register_status == '1' ? 'success' : 'warning'}}">{{$user->register_status == '1' ? 'Activated' : 'Not Activated'}}</span>
                                    </td>
                                    <td class="td-actions text-right">
                                        <a rel="tooltip" class="btn btn-danger btn-link" href="#" data-original-title=""
                                             data-placement="bottom" title="Erase"
                                            id="delete-user">
                                            <i class="material-icons">delete</i>
                                            <div class="ripple-container"></div>
                                        </a>
                                    <a rel="tooltip" class="btn btn-primary btn-link" href=""
                                            data-original-title="" data-placement="bottom"
                                    title="Edit" id="edit-user" data-toggle="modal" data-target="#editUser">
                    ...
                    <form class="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="bmd-form-group{{ $errors->has('phone') ? ' has-danger' : '' }} mt-3">
                            <div class="input-group">
                                ...
                                <input type="number" name="phone" class="form-control"
                                    placeholder="{{ __('081231923479...') }}" value="" required>
                            </div>
                            @if ($errors->has('phone'))
