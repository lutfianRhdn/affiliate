...
(function (factory) {
    ...
    $.extend(true, DataTable.defaults, {
        dom: "<'mdc-layout-grid'<'mdc-layout-grid__inner'" +
            "<'mdc-cell mdc-layout-grid__cell--span-6 mr-5'l>" +
            "<'mdc-cell mdc-layout-grid__cell--span-6 ml-5'f>" +
            ">>" +
    ...
    $.extend(DataTable.ext.classes, {
        ...
        sFilterInput: "form-control input-sm ml-2 mr-2",
        sLengthSelect: "form-control input-sm ml-2 mr-2",
